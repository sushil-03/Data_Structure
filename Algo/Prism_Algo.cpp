...
/*
Step to be followed :
All node weight are infinite except source
We would start from source
    1. Select  node with minimum weight
    2. Include selected node in setMST
    3. Relax and compute all adjacent list

    3.Repeat step 1,2,3 unless all edges are included in setMst
*/
